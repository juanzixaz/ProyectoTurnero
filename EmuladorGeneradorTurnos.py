...
#py -3.1 "C:\Users\juanz\Google Drive\Semestre 6\Laboratorio Electronica Digital\ProyectoTurnero\Archivos Temp (No necesarios)\EmuladorGeneradorTurnos.py"
...
TextoMensaje1 = Mensaje1.render("Emulador - Generador de Turnos", True, Negro, Blanco)
...
TextoMensaje0 = Mensaje0.render("presione 'n' para un nuevo turno", True, Negro, Blanco)
...
while 1:
    ...
    if contadorParpadeoRecibo < 5000:
        TextoMensaje2_1 = Mensaje2_1.render(str(datoCOM1), True, Azul, Blanco)
        pantalla.blit(TextoMensaje2_1, RectTextoMensaje2_1)
